...
const Landing = props => (
	<Layout>
		...
		<ProjectBanner
			...
			subtitle="Tapas Restaurant Belfast"
			image={outside1}
		/>
		...
		<div id="main">
			<section id="one">
				<div className="inner">
					...
					<p>
						2Taps Winebar wanted their old website updating, mainly to increase
						the readability of their extensive menu. But also to increase their
